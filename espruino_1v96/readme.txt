...
espruino_1v96_pico_1r3_cc3000.bin  
espruino_1v96_pico_1r3_wiznet.bin  
...
espruino_1v96_stm32l496gdiscovery.bin
   - STM32F496GDISCOVERY board

espruino_1v96_stm32vldiscovery.bin
   - STM32VLDISCOVERY board

espruino_1v96_stm32f3discovery.bin
   - STM32F3DISCOVERY board
   
espruino_1v96_stm32f4discovery.bin
   - STM32F4DISCOVERY board

espruino_1v96_nucleof401re.bin
   - ST NUCLEO-F401RE board

espruino_1v96_nucleof411re.bin
   - ST NUCLEO-F411RE board

espruino_1v96_raspberrypi
...
espruino_1v96_esp8266_combined_512.bin
   - ESP8266 'combined' port for 512k devices like ESP01
       Flash with: esptool.py write_flash 0 espruino_1v96_esp8266_combined_512.bin

espruino_1v96_esp8266_4mb_combined_4096.bin
   - ESP8266 'combined' port for 4MB devices like ESP12
       Flash with: esptool.py write_flash 0 espruino_1v96_esp8266_combined_4096.bin

espruino_1v96_esp8266
